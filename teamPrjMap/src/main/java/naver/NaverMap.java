...
public class NaverMap implements ActionListener {
    Project01F naverMap;
    public NaverMap(Project01F naverMap) {
        this.naverMap = naverMap;
    }

    @Override
    public void actionPerformed(ActionEvent e) {
        String clientId = "mfkfm85e4s";
        String clientSecret = "1WxPfiPXEAME4aTzQ6XGXJrwS4y7FFp5WzkEOb99";
        AddressVO vo = null;
    ...
    public void map_service(AddressVO vo) {
        ...
        try {
            ...
            HttpURLConnection con = (HttpURLConnection) url.openConnection();
            con.setRequestMethod("GET");
            con.setRequestProperty("X-NCP-APIGW-API-KEY-ID", "mfkfm85e4s");
            con.setRequestProperty("X-NCP-APIGW-API-KEY", "1WxPfiPXEAME4aTzQ6XGXJrwS4y7FFp5WzkEOb99");
