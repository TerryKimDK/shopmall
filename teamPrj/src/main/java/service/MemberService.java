...
public class MemberService {
    ...
    public MemberDTO getMember(String id) {return factory.getInstance().selectOne("MemberMapper.getMember", id);}

    public int update(MemberDTO member) {return factory.getInstance().update("MemberMapper.update", member);}
